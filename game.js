...
class Lvl3 extends Phaser.Scene {
  ...
  create() {
    ...
    //platforms
    this.ground = this.createRect(0, window.innerHeight - 10, window.innerWidth * 2, 100)
    this.wall = this.createRect(window.innerWidth / 2, window.innerHeight / 2 + -500, 50, window.innerHeight)
    this.platform1 = this.createRect(window.innerWidth / 2 - 200, window.innerHeight + 500, 400, 25)
